...
# Налаштовуємо конфігурацію фронтенду для Demo середовища
"$SCRIPT_DIR/configure_frontend.sh" "demo" "localhost"

# Запускаємо фронтенд
echo "Запуск фронтенду для Demo середовища на порту 8081..."
...
echo ""
echo "Фронтенд для Demo середовища запущено!"
echo "Доступний на: http://localhost:8081"
echo "API URL налаштовано на: http://localhost:6501/api"
echo ""
